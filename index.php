...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyC6zlt18dI60PLpwmc7IRIf6CeB2KtwUJk"></script>
      <style>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="phonenumber" id="phonenumber" placeholder="Phone Number" maxlength="15">
                  </div>
                  <div class="form-group">
  ...
  <!-- Footer-->
      <div class="footer">
        <div class="container">
              <p> &copy; 2015-<?php $today = date("Y"); echo $today?>.</p>
          </div>
        </div>
